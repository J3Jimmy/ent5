  ...
  return (
    <div className="container__poke__card">
      <div className="pokemon__page__card">
        ...
        />
        <div className="id__button">
  <p className="id__">#{pokemon?.id}</p>
</div>

        <h2 className="name__">{pokemon?.name}</h2>
        <div className="row__wh">
      <p className="weight__height"><strong>Weight:</strong> {pokemon?.weight}</p>
      <p className="weight__height"><strong>Height:</strong> {pokemon?.height}</p>
    </div>
        <div className="TandH">
    ...
    {pokemon?.stats.map((stat, index) => (
      <li key={index}>
        ...
        <br />
        <progress value={stat.base_stat} max={150} className="progress__poke__page"></progress>
        <span>{stat.base_stat}/150</span>
      </li>
    ))}
  </ul>
</div>
        <div className="poke__page__moves">
